...
import './beauty-and-health.sass'

function BeautyAndHealthPages() {
    const [count, setCount] = useState(0)

    const products = [
        {
            id: 1,
            name: "Фен Dyson Supersonic Nural HD16 бирюзовый/оранжевый",
            description: "[компактный, 1600 Вт,  шнур - 1.8 м]",
            price: "35 999 ₽",
            monthlyPayment: "от 1 528 ₽/мес.",
            rating: 4.81,
            reviews: 105,
        ...
        {
            id: 2,
            name: "Фен Dyson Supersonic HD15 серебристый/розовый",
            description: "[компактный, 1600 Вт,  шнур - 1.8 м]",
            price: "39 999 ₽",
        ...
        {
            id: 3,
            name: "Фен Babyliss Pro Caruso BAB6510 черный",
            description: "[полноразмерный, 2400 Вт,  шнур - 2.7 м]",
            price: "5 999 ₽",
            monthlyPayment: "от 255 ₽/мес.",
            rating: 4.81,
            reviews: 66,
            reliability: "Отличная надежность",
            code: "1247270",
        ...
        {
            id: 4,
            name: "Фен Aceline Super Hair Dryer серый/розовый",
            description: "[компактный, 1600 Вт, шнур - 1.8 м]",
            price: "55 999 ₽",
            monthlyPayment: "от 1 528 ₽/мес.",
            rating: 4.87,
    ...
    const hotTopics = [
        "Дорогие и дешевые фен-щётки — в чем отличия?",
        "6 ошибок при выборе фен-щётки",
        "Как выбрать фен для волос",
        "Все про фены для волос"
    ]

    return (
        <div className="beauty-health-container">
            <header className="page-header">
                <h1 className="page-title">Товары для красоты и здоровья</h1>
            </header>
...
export default BeautyAndHealthPages